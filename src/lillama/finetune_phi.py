...
model, tokenizer = prepare_model(hf_model="/gpfsdswork/dataset/HuggingFace_Models/microsoft/phi-2/",
...
args = TrainingArguments(
    output_dir="/lustre/fsn1/projects/rech/knb/urc37ho/finetuned-phi2-1.7b-slimorca", # directory to save and repository id
...
trainer.train()
trainer.save_model("/lustre/fsn1/projects/rech/knb/urc37ho/finetuned-phi2-1.7b-slimorca/model")
tokenizer.save_pretrained("/lustre/fsn1/projects/rech/knb/urc37ho/mistral-4b-slimorca-2/model")
